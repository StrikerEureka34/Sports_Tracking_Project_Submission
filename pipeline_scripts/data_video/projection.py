...
class TopViewProjector:
    ...
    def __init__(self, source_points=None, dest_points=None, field_width=None, 
                 field_height=None, output_width=None, output_height=None):
        field_width = field_width or config.HOMOGRAPHY_CONFIG["field_width"]
        field_height = field_height or config.HOMOGRAPHY_CONFIG["field_height"]
        output_width = output_width or config.HOMOGRAPHY_CONFIG["output_width"]
        output_height = output_height or config.HOMOGRAPHY_CONFIG["output_height"]
