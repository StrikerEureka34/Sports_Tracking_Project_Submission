...
class VideoVisualizer:
    def __init__(
        self,
        bbox_thickness: int = config.VISUALIZATION_CONFIG["bbox_thickness"],
        text_scale: float = config.VISUALIZATION_CONFIG["text_scale"],
        trajectory_length: int = config.VISUALIZATION_CONFIG["trajectory_length"]
    ):
