...
class TrajectoryAnalytics:
    """Accumulates tracking data and computes movement analytics."""
    
    def __init__(self, field_width=None, field_height=None, heatmap_bins=None, 
                 smoothing_window=None, min_track_length=None):
        field_width = field_width or config.HOMOGRAPHY_CONFIG["output_width"]
        field_height = field_height or config.HOMOGRAPHY_CONFIG["output_height"]
        heatmap_bins = heatmap_bins or config.ANALYTICS_CONFIG["heatmap_bins"]
        smoothing_window = smoothing_window or config.ANALYTICS_CONFIG["smoothing_window"]
        min_track_length = min_track_length or config.ANALYTICS_CONFIG["min_track_length"]
